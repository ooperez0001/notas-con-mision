    ...
    <>
      ...
      <div className="p-6 space-y-8 animate-fade-in max-w-4xl mx-auto">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <div
            className="bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 p-6 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 cursor-pointer transition-all hover:shadow-md hover:border-blue-300
  "
          >
